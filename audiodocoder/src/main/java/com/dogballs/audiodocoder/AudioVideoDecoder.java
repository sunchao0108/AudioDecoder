 ...
 *            AssetFileDescriptor}.
 */
public class AudioVideoDecoder<T> implements ResourceDecoder<T, Bitmap> {
    ...
    private final ResourceDecoder<ByteBuffer, Bitmap> byteBufferBitmapDecoder;

    public static ResourceDecoder<AssetFileDescriptor, Bitmap> asset(BitmapPool bitmapPool, ResourceDecoder<ByteBuffer, Bitmap> byteBufferBitmapDecoder) {
        return new AudioVideoDecoder<>(bitmapPool, new AssetFileDescriptorInitializer(), byteBufferBitmapDecoder);
    }

    public static ResourceDecoder<ParcelFileDescriptor, Bitmap> parcel(BitmapPool bitmapPool, ResourceDecoder<ByteBuffer, Bitmap> byteBufferBitmapDecoder) {
        return new AudioVideoDecoder<>(bitmapPool, new ParcelFileDescriptorInitializer(), byteBufferBitmapDecoder);
    }

    public AudioVideoDecoder(BitmapPool bitmapPool, MediaMetadataRetrieverInitializer<T> initializer, ResourceDecoder<ByteBuffer, Bitmap> byteBufferBitmapDecoder) {
        this(bitmapPool, initializer, DEFAULT_FACTORY, byteBufferBitmapDecoder);
    }
    ...
    AudioVideoDecoder(
            ...
            MediaMetadataRetrieverFactory factory, ResourceDecoder<ByteBuffer, Bitmap> byteBufferBitmapDecoder) {
        this.bitmapPool = bitmapPool;
        this.initializer = initializer;
        this.factory = factory;
        this.byteBufferBitmapDecoder = byteBufferBitmapDecoder;
    }
